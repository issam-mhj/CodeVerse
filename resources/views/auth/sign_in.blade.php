...
<body class="h-screen">
    <div class="flex h-full">
        ...
        <!-- Left Side (formerly right) - Login Form -->
        <div class="w-full md:w-1/2 bg-white flex flex-col">
            @if (session('message'))
                <div
                    class="w-full md:w-1/2 bg-green-100 border-l-4 border-green-500 text-green-800 p-4 rounded-lg shadow-md flex items-center mb-4">
                ...
                <div class="max-w-md w-full">
                    ...
                    <form action="/login" method="POST" class="mt-8 space-y-4">
                        ...
                        <div>
                            @if (session('error'))
                                <div
                                    class="w-full bg-red-100 border-l-4 border-red-600 text-red-800 p-4 rounded-lg shadow-md flex items-center mb-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-medium text-gray-800 hover:underline">
                    ...
                    <p class="mt-6 text-center text-sm text-gray-500">
                        ...
                        and
                        <a href="#" class="text-gray-600 underline">Terms of Service</a>
                        apply.
                    </p>
                </div>
            </div>
        ...
        <!-- Right Side (formerly left) - Welcome/Branding -->
        <div class="hidden md:flex md:w-1/2 bg-gray-900 text-white flex-col relative">
            <div class="flex-grow flex flex-col items-center justify-center px-8">
                <div class="max-w-md mx-auto text-center">
                    ...
                    <p class="text-gray-300 mb-6">
                        Reconnect with your developer community, projects,
                        and peers.
                    </p>
                </div>
            </div>
